...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes $(O3) $(GRAPHITE) $(PIPE) $(MISC) $(NOWARN)
HOSTCXXFLAGS = $(O3) $(GRAPHITE) $(PIPE) $(MISC) $(NOWARN)
...
KBUILD_CFLAGS	+= $(O3) $(GRAPHITE) $(PIPE) $(MISC) $(NOWARN)
